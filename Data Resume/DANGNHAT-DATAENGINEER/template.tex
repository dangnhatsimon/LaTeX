...
\begin{cvtable}[3]
	\cvitem{Oct 2022 -- Present}{Data Engineer}{PECC2}{-Contribute to Big Data Development Plan for Company. Writing automation script with Python and GUI, shell scripting on Linux to help company decrease working time.\\
    -Monitoring health of server computers, ingest weather and machine sensor data from power plants to database server at Company. Cleaning, manipulating, processing data with 1GB/day (estimated), ensure data integrity, ethics and available to Data Scientist and ML Teams. \\
