...
\begin{cvtable}[3]
    ...
    - CI/CD: Implemented GitLab CI/CD pipelines to automate testing, build, and deployment processes.\\
    - Metadata Management \& Data Lineage: implemented OpenLineage, DataHub to track and manage data lineage, dependencies, and metadata across Airflow and Spark pipelines.\\
    ...
    - Skills: Python, Java, AWS, GCP, Spark, Beam, Kafka, Data Architecture, Docker, Kubernetes, GitLab, CI/CD, Integrated Businesses in Closed Loop.}
\end{cvtable}
...
\begin{cvtable}[3]
    ...
    - Skills: Data Engineering, ETL \& Data Pipelines, RDBMS, NoSQL and Big Data, Spark, Kafka, Beam, CI/CD, Python, SQL, Scripting, Docker, Git, Cloud.}    
\end{cvtable}
...
\begin{cvtable}
    ...
    \cvitem{DevOps}{Docker, Kubernetes, GitLab CI.}{}{}
    \cvitem{Metadata}{OpenLineage, DataHub.}{}{}
